                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <div className="aspect-video bg-[var(--bg-card)] rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                                <img src="/approved/1.jpg" alt="Gallery 1" className="w-full h-full object-cover" onError={(e) => e.currentTarget.parentElement.style.display = 'none'} />
                            </div>
                            <div className="aspect-video bg-[var(--bg-card)] rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                                <img src="/approved/2.jpg" alt="Gallery 2" className="w-full h-full object-cover" onError={(e) => e.currentTarget.parentElement.style.display = 'none'} />
                            </div>
                            <div className="aspect-video bg-[var(--bg-card)] rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                                <img src="/approved/3.jpg" alt="Gallery 3" className="w-full h-full object-cover" onError={(e) => e.currentTarget.parentElement.style.display = 'none'} />
                            </div>
                        </div>
                    </section>
                </div>
